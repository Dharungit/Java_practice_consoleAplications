...
public class Atm {
    ...
    public static int atmBalence() {
        int ans = 0;
        for (int i = 0; i < AtmBalance.length; i++) {
            if (i == 0)
                ans += AtmBalance[i] * 2000;
            if (i == 1)
                ans += AtmBalance[i] * 500;
            if (i == 2)
                ans += AtmBalance[i] * 200;
            if (i == 3)
                ans += AtmBalance[i] * 100;
        }
        return ans;
    }
    ...
    public static int[] withdraw(int am) {
        ...
        while (am > 0) {
            while (am >= 2000 && AtmBalance[0] > 0) {
                am -= 2000;
                amt_arr[0] += 1;
                AtmBalance[0] -= 1;
            }
            while (am >= 500 && AtmBalance[1] > 0) {
                am -= 500;
                amt_arr[1] += 1;
                AtmBalance[1] -= 1;
            }
            while (am >= 200 && AtmBalance[2] > 0) {
                am -= 200;
                amt_arr[2] += 1;
                AtmBalance[2] -= 1;
            }
            while (am >= 100 && AtmBalance[3] > 0) {
                am -= 100;
                amt_arr[3] += 1;
                AtmBalance[3] -= 1;
            }
    ...
    public static int admin() {
        while (true) {
            ...
            if (c == 1) {
                ...
                System.out.println();
                System.out.println("2000 count : " + AtmBalance[0] + "\nAmount Present : " + AtmBalance[0] * 2000);
                System.out.println();
                System.out.println("500 count : " + AtmBalance[1] + "\nAmount Present : " + AtmBalance[1] * 500);
                System.out.println();
                System.out.println("200 count : " + AtmBalance[2] + "\nAmount Present : " + AtmBalance[2] * 200);
                System.out.println();
                System.out.println("100 count : " + AtmBalance[3] + "\nAmount Present : " + AtmBalance[3] * 100);
                System.out.println();
                System.out.println("Total Balance : " + atmBalence());
                System.out.println();
                System.out.println("Press ENTER to countinue");
                sc.nextLine();
                sc.nextLine();
    ...
    public static int atm(int curr_user) {
        while (true) {
            ...
            if (c == 1) {
                ...
                int am = sc.nextInt();
                while (true) {
                    int flag = 0, flag1 = 0, flag2 = 0, th = AtmBalance[0], fi = AtmBalance[1], tw = AtmBalance[2],
                            hu = AtmBalance[3];
                    if (am > atmBalence()) {
    ...
    public static void main(String[] args) {
        ...
        atm = new Atm[2];
        atm[0] = new Atm("User1", "123", 3500);
        atm[0].User_Statement = new ArrayList<>();
        atm[1] = new Atm("User2", "123", 1500);
