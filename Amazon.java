...
public  class Amazon {
    ...
    public static void main(String[] args) {
        ...
        User.user_list.add(new User("User1", "123", ++User.user_id_incr));
        Admin.merchants.add(new Admin("Merchant1", "123", ++Admin.merchant_id, true));
...
class Admin {
    ...
    public static int Admin_login() {
        ...
        String pass = sc.next();
        if (U_name.equals("Admin") && pass.equals("123")) {
            // admin panel
            admin_panel();
